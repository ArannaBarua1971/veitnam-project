...
function AddMemberShip() {
  ...
  const submit = async () => {
    const request = {
      ...
      membership_title,
      months: {
        month3: month_due3 ? {month:"3",price:price,discount:discount3}:null,
        month6: month_due6 ? {month:"6",price:price*6,discount:discount6}:null,
        month12: month_due12 ? {month:"12",price:price*12,discount:discount12}:null
      },
    };
    ...
    <div>
      ...
      <section className="mt-4">
        ...
        <div className="catagory_selector">
          <ContentHeader className="text-white h5 py-3">
            Catagory* :
          </ContentHeader>
          <select
        ...
        <div className="membership_info my-4">
          ...
          <div className="months mt-3">
            ...
            <div className="second_month_duration bg-white rounded p-3 mx-2">
              <Input
                name="month_due6"
            ...
            <div className="third_month_duration bg-white rounded p-3">
              <Input
                name="month_due12"
        ...
        <Button className="px-4 py-3 mt-3  border-0 rounded" onClick={submit}>
          ADD membership
        </Button>
      </section>
    </div>
